 ...
 * @version 2021.12.09 09:56:35 // Generated by ComTest
 *
 */
...
public class KerhoTest {
  ...
  // Generated by ComTest BEGIN
  /** 
   * testLueTiedostosta42 
   * @throws IOException when error
   */
  @Test
  public void testLueTiedostosta42() throws IOException {    // Kerho: 42
    Kerho k = new Kerho(); 
    k.lueTiedostosta(".\\testit\\nimetLukuTest.dat", ".\\testit\\paivatLukuTest.dat"); 
    assertEquals("From: Kerho line: 49", 7, k.getPelureita()); 
    ...
    assertEquals("From: Kerho line: 64", true, tulos.equals(sb.toString())); 
    ...
    assertEquals("From: Kerho line: 78", true, tulos.equals(sb.toString())); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testTallenna92() throws IOException {    // Kerho: 92
    ...
    k.tallenna(".\\testit\\nimet", ".\\testit\\paivat"); 
    assertEquals("From: Kerho line: 153", null, VertaaTiedosto.vertaaFileString(".\\testit\\nimet.dat", tulosNimet)); 
    assertEquals("From: Kerho line: 154", null, VertaaTiedosto.vertaaFileString(".\\testit\\paivat.dat", tulosPaivat)); 
    VertaaTiedosto.tuhoaTiedosto(".\\testit\\nimet.dat"); 
    VertaaTiedosto.tuhoaTiedosto(".\\testit\\paivat.dat"); 
    VertaaTiedosto.tuhoaTiedosto(".\\testit\\nimet.bak"); 
    VertaaTiedosto.tuhoaTiedosto(".\\testit\\paivat.bak"); 
  ...
  /** testLisaa182 */
  @Test
  public void testLisaa182() {    // Kerho: 182
    Kerho k = new Kerho(); 
    ...
    ben2.rekisteroi(); 
    assertEquals("From: Kerho line: 191", false, ben2.equals(k.getPeluri(0))); 
    assertEquals("From: Kerho line: 192", true, k.getPeluri(0).equals(ben1)); 
  } // Generated by ComTest END
  ...
  /** testPoistaPeluri232 */
  @Test
  public void testPoistaPeluri232() {    // Kerho: 232
    Kerho k = new Kerho(); 
    Peluri ben1 = new Peluri("1|Ben One|Ben_O|1000|0509289339"); 
    k.lisaa(ben1); 
    Peluri ben2 = new Peluri("2|Ben Two|Ben_T|1000|0509289000"); 
    k.lisaa(ben2); 
    assertEquals("From: Kerho line: 238", 2, k.getPelureita()); 
    assertEquals("From: Kerho line: 239", true, k.getPeluri(0).equals(ben1)); 
    assertEquals("From: Kerho line: 240", true, k.getPeluri(1).equals(ben2)); 
    List<Paiva> l = k.getPaivat(ben1); 
    assertEquals("From: Kerho line: 242", 7, l.size()); 
    k.poistaPeluri(ben1.getPeluriId()); 
    assertEquals("From: Kerho line: 245", 1, k.getPelureita()); 
    assertEquals("From: Kerho line: 246", true, k.getPeluri(0).equals(ben2)); 
    l = k.getPaivat(ben2); 
    assertEquals("From: Kerho line: 248", 7, l.size()); 
    k.poistaPeluri(ben2.getPeluriId()); 
    assertEquals("From: Kerho line: 251", 0, k.getPelureita()); 
    try {
    assertEquals("From: Kerho line: 252", false, k.getPeluri(0).equals(ben1)); 
    fail("Kerho: 252 Did not throw IndexOutOfBoundsException");
    } catch(IndexOutOfBoundsException _e_){ _e_.getMessage(); }
    l = k.getPaivat(ben1); 
    assertEquals("From: Kerho line: 254", 0, l.size()); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testMuokkaaTietoja270 */
  @Test
  public void testMuokkaaTietoja270() {    // Kerho: 270
    Kerho k = new Kerho(); 
    Peluri ben1 = new Peluri("1|Ben One|Ben_O|1000|0509289339"); 
    k.lisaa(ben1); 
    String[] tiedot = { "nimi muutettu", "pnimi muutettu", "500", "00000000000"} ; 
    k.muokkaaTietoja(ben1.getPeluriId(), tiedot); 
    assertEquals("From: Kerho line: 276", "1|nimi muutettu|pnimi muutettu|500|00000000000", k.getPeluri(0).toString()); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testMuokkaaAikoja290 */
  @Test
  public void testMuokkaaAikoja290() {    // Kerho: 290
    Kerho k = new Kerho(); 
    Peluri ben1 = new Peluri("1|Ben One|Ben_O|1000|0509289339"); 
    k.lisaa(ben1); 
    List<Paiva> l = k.getPaivat(ben1); 
    ...
    int i = 0; 
    for (Paiva paiva : l) {
    assertEquals("From: Kerho line: 299", true, paiva.toString().equals("1|"+paivat[i]+"|00|00|00|00")); 
    i++; 
    }
    String[][] muutetutAjat = {
    {"12","12","13","13"},
    ...
    i = 0; 
    for (Paiva paiva : l) {
    assertEquals("From: Kerho line: 315", true, paiva.toString().equals("1|"+paivat[i]+"|12|12|13|13")); 
    i++; 
    }
  } // Generated by ComTest END
  ...
  /** testGetPaivat357 */
  @Test
  public void testGetPaivat357() {    // Kerho: 357
    ...
    assertEquals("From: Kerho line: 373", 0, loytyneet.size()); 
    loytyneet = kerho.getPaivat(ben1); 
    assertEquals("From: Kerho line: 375", 2, loytyneet.size()); 
    assertEquals("From: Kerho line: 376", true, loytyneet.get(0) == maanantai1); 
    assertEquals("From: Kerho line: 377", true, loytyneet.get(1) == tiistai1); 
    loytyneet = kerho.getPaivat(ben2); 
    assertEquals("From: Kerho line: 379", 3, loytyneet.size()); 
    assertEquals("From: Kerho line: 380", true, loytyneet.get(0) == maanantai2); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testOnkoMuutettu392() throws IOException {    // Kerho: 392
    Kerho k = new Kerho(); 
    assertEquals("From: Kerho line: 397", false, k.onkoMuutettu()); 
    k.lisaa(new Peluri("1|Ben One|Ben_O|1000|0509289339")); 
    assertEquals("From: Kerho line: 399", true, k.onkoMuutettu()); 
    k.tallenna(".\\testit\\nimetOnkoMuutettu", ".\\testit\\paivatOnkoMuutettu"); 
    assertEquals("From: Kerho line: 401", false, k.onkoMuutettu()); 
